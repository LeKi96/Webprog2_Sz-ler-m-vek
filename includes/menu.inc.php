...
Class Menu {
    ...
    public static function setMenu() {
        ...
        $stmt = $connection->query("select url, name, parent, privilage from menu where privilage like '".$_SESSION['userlevel']."'order by list");
        while($menuitem = $stmt->fetch(PDO::FETCH_ASSOC)) {
            self::$menu[$menuitem['url']] = array($menuitem['name'], $menuitem['parent'], $menuitem['privilage']);
        }
    }
